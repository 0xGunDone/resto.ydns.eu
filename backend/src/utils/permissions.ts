...
export const DEFAULT_EMPLOYEE_PERMISSIONS: PermissionCode[] = [
  ...
  PERMISSIONS.REQUEST_SHIFT_SWAP, // Может запрашивать обмен сменами
  PERMISSIONS.VIEW_ANNOUNCEMENTS, // Может просматривать объявления
];


// Предустановленные должности с правами для новых ресторанов
export const PRESET_POSITIONS: Record<string, PermissionCode[]> = {
  'Официант': [
    PERMISSIONS.VIEW_SCHEDULE,
