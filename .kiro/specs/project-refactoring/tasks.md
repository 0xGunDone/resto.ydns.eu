...
- [x] 15. Интеграция и подключение
  - [x] 15.1 Подключить Error Handler в index.ts
    - Заменить текущий error handler на новый
    - Убрать дублирование логики ошибок
    - _Requirements: 8.1_

  - [x] 15.2 Подключить Logger во все сервисы
    - Заменить console.log на logger
    - Добавить контекст (userId, restaurantId) в логи
    - _Requirements: 7.2_

  - [x] 15.3 Обновить index.ts для загрузки сессий бота
